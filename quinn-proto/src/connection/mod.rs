...
pub use streams::{
    Chunks, FinishError, ReadResult, ReadStatus, ReadableError, ShouldTransmit, StreamEvent,
    ...
    S: crypto::Session,
{
    ...
    pub fn read(&mut self, id: StreamId, ordered: bool) -> Result<Chunks<'_>, ReadableError> {
        self.streams
